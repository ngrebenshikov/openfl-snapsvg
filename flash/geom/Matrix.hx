...
class Matrix {
	...
	public function transformPoint (inPos:Point) {
		...
		return new Point (__transformX (inPos), __transformY (inPos));
	...
	public inline function __transformX (inPos:Point):Float {
	...
	public inline function __transformY (inPos:Point):Float {
	...
	public inline function __translateTransformed (inPos:Point):Void {
		
		tx = __transformX (inPos);
		ty = __transformY (inPos);
