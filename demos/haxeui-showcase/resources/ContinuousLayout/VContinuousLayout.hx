...
@:build(haxe.ui.toolkit.core.Macros.buildController("assets/resources/ContinuousLayout/VContinuousLayout.xml"))
class VContinuousLayout extends XMLController { 
