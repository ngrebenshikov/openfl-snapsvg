...
var BunnyMark = function() {
	...
	this.addChild(new tests.BitmapTest());
...
tests.BitmapTest = function() {
	...
	this.numBunnies = 100;
	this.incBunnies = 20;
	this.bunnyAsset = openfl.Assets.getBitmapData("assets/wabbit_alpha.png");
	...
	while(_g1 < _g) {
		...
		bitmap = new openfl.display.Bitmap(this.bunnyAsset);
...
$hxClasses["tests.BitmapTest"] = tests.BitmapTest;
tests.BitmapTest.__name__ = ["tests","BitmapTest"];
tests.BitmapTest.__super__ = openfl.display.Sprite;
tests.BitmapTest.prototype = $extend(openfl.display.Sprite.prototype,{
	...
	,enterFrame: function(e) {
		...
		while(_g1 < _g) {
			...
			bitmap.set_x(bunny.position.x);
			bitmap.set_y(bunny.position.y);
			bitmap.set_rotation(bunny.rotation);
			bitmap.set_alpha(bunny.alpha);
			bitmap.set_scaleX(bitmap.set_scaleY(bunny.scale));
		}
