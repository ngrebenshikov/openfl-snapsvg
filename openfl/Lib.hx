...
class Lib {
	...
	private static var HTML_DIV_EVENT_TYPES = [ 'dragstart', 'resize', /*'mouseup',*/ 'mouseover', 'mouseout', /*'mousemove', 'mousedown',*/'wheel'/*, 'dblclick', 'click'*/ ];
					...
					if (allElements != null) {
						...
						for (elIdx in 0...allElements.length) {
							...
							if (program != null) {
								...
								interp.variables.set ("createDOMEvent", function (t, e) return new openfl.events.DOMEvent (t, e));
